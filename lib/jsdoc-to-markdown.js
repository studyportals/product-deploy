...
module.exports = () =>{
	...
	header.push(`[![David](https://img.shields.io/david/${usernameRepo}.svg?style=flat)](https://david-dm.org/${usernameRepo})`);
	header.push(`[![David](https://img.shields.io/david/dev/${usernameRepo}.svg?style=flat)](https://david-dm.org/${usernameRepo}#info=devDependencies)`);
	header.push(``);
