...
class Deploy{
	...
	workingCopy(){
		...
		return this.prepare()
			...
			.then(() => {return _sass(this.opts.to, this.opts.enableCompression); })
			.then(() => {return _js(this.opts.to, this.opts.enableCompression); })
	};
	...
	startWatchers(){
		...
		_js_watcher(this.opts.gulp, this.opts.to, this.opts.enableCompression);
		_css_watcher(this.opts.gulp, this.opts.to, this.opts.enableCompression);
