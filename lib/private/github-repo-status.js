 ...
 * @param {int} [skipped] - The amount of skipped tests
 *
 * Env vars:
 ...
 * @return {Promise}
 */
function github_repo_status(repo, failures, total, skipped){
	...
	if(failures === 0){
		...
		request_body.description = `${total} passed`;
	}
	else{
	...
	if(skipped){
		...
		request_body.description += ` (${skipped} skipped...)`
	}
